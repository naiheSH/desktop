...
export function getUpdatesURL() {
  ...
  if (process.platform === 'win32') {
    return `https://naiheSH.github.io/desktop-metadata/win32-${getDistArchitecture()}-${getChannel()}`
    // example: https://naiheSH.github.io/desktop-metadata/win32-x64-production/RELEASES
  } else if (process.platform === 'darwin') {
    return `https://naiheSH.github.io/desktop-metadata/darwin-${getDistArchitecture()}-${getChannel()}/releases.json`
    // example: https://naiheSH.github.io/desktop-metadata/darwin-arm64-production/releases.json
  } else {
